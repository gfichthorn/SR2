...
/*
	...
	public void testDetermineDistancePositive1() {
		...
		assertTrue(network.getNode(0).determineDistance(network.getNode(0), network.getNode(1)) == 5);
	}
	...
	public void testDetermineDistanceAcrossOrigin2() {
		...
		assertTrue(network.getNode(0).determineDistance(network.getNode(0), network.getNode(1)) == 25);
	}
	...
	public void testDetermineNextHop1() {
		...
		assertEquals(network.getNode(0).determineNextHop(network.getNodeList(), network.getNode(2)), network.getNode(1));
	}
	...
	public void testDetermineNextHop2() {
		...
		assertEquals(network.getNode(0).determineNextHop(network.getNodeList(), network.getNode(3)), network.getNode(2));
	}
	...
	public void testDetermineNextHop3() {
		...
		assertEquals(network.getNode(0).determineNextHop(network.getNodeList(), network.getNode(4)), network.getNode(2));
	}
	...
	public void testDetermineNextHopNoNextHop() {
		...
		assertEquals(network.getNode(0).determineNextHop(network.getNodeList(), network.getNode(1)), network.getNode(0));
	}
	...
	public void testDetermineNextHopInRange() {
		...
		//System.out.println(network.determineNextHop(network.getNode(0), network.getNode(2)).getUid());
		assertEquals(network.getNode(0).determineNextHop(network.getNodeList(), network.getNode(2)), network.getNode(2));
	}
	...
	public void testForwardPacketFail1() {
		...
		network.addNode(10, 10, 10); //1st node
		Packet p = new Packet();
		//assertFalse(network.getNode(0).forwardPacket(network.getNodeList(), network.getNode(1), p));
	...
	public void testForwardPacketFail2() {
		...
		Packet p = new Packet();
		//assertFalse(network.getNode(0).forwardPacket(network.getNodeList(), network.getNode(2), p));
	...
	public void testForwardPacketOneHop1() {
		...
		network.addNode(10, 1, 1); //1st node
		Packet p = new Packet();
		//assertTrue(network.getNode(0).forwardPacket(network.getNodeList(), network.getNode(1), p));
	...
	public void testForwardPacketOneHop2() {
		...
		Packet p = new Packet();
		//assertTrue(network.getNode(0).forwardPacket(network.getNodeList(), network.getNode(2), p));
	...
	public void testForwardPacketTwoHop1() {
		...
		Packet p = new Packet();
		//assertTrue(network.getNodeList().get(0).forwardPacket(network.getNodeList(), network.getNode(2), p));
	...
	public void testReceivePacket1() {
		...
		network.addNode(10, 0, 0); //0th node
		Packet p = new Packet();
		network.getNode(0).receivePacket(network.getNode(0), p);
	...
	public void testSendDummyPacketOneHop1() {
		...
		network.addNode(10, 0, 0); //0th node
		network.addNode(10, 1, 1); //1st node
		//assertTrue(network.getNode(0).sendDummyPacket(network.getNodeList(), network.getNode(1)));
		assertTrue(network.getNode(0).getDropped() == 0);
		assertTrue(network.getNode(0).getForwarded() == 0);
	...
	public void testSendDummyPacketOneHop2() {
		...
		network.addNode(10, 1, 1); //1st node
		network.addNode(10, 2, 2); //2nd node
		//assertTrue(network.getNode(0).sendDummyPacket(network.getNodeList(), network.getNode(2)));
		assertTrue(network.getNode(0).getDropped() == 0);
		assertTrue(network.getNode(0).getForwarded() == 0);
		assertTrue(network.getNode(0).getReceived() == 0);
		assertTrue(network.getNode(0).getSent() == 1);
	...
	public void testThreads1() {
		...
		network.addNode(10, 5, 5); //1st node
		network.addNode(10, 10, 10); //2nd node
		network.getNode(0).start();
		network.getNode(1).start();
		network.getNode(2).start();
	}*/
